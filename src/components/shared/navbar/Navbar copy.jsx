...
function Navbar() {
  return (
    <header className="w-full font-raleway text-white mt-14 pr-10">
      <nav>
        <div className="flex items-center justify-between gap-6">
          ...
          <div className="w-full max-w-[230px]">
            <button className="w-full flex items-center justify-between bg-gradient py-5 px-4 gap-5 text-sm rounded-xl">
