  ...
  return (
    <div className={`flex-1 flex flex-col  gap-2 md:gap-4 ${wrapperClass}`}>
      ...
      <div className="w-full">
        <label
          htmlFor={name}
          className={`w-[200px] aspect-square rounded-full text-white text-4xl flex flex-col justify-center items-center gap-4  cursor-pointer border border-white-300 relative`}
        >
          <img
